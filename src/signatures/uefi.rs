...
pub fn uefi_capsule_magic() -> Vec<Vec<u8>> {
    vec![
        ...
        b"\x90\xBB\xEE\x14\x0A\x89\xDB\x43\xAE\xD1\x5D\x3C\x45\x88\xA4\x18".to_vec(), // AMI Aptio unsigned capsule GUID
        b"\x62\x70\xE0\x3B\x51\x1D\xD2\x45\x83\x2B\xF0\x93\x25\x7E\xD4\x61".to_vec(), // Toshiba capsule GUID
    ]
}
